      ...
      <div className="max-w-6xl w-full bg-white p-10 shadow-xl rounded-lg"> {/* Increased max-width here */}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-start space-x-4 mt-6">
            <button
              type="submit"
              className="py-2 px-6 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
